...
class mx_std_ring_resonator(mdl.my_std_ring_resonator) :
    def __init__(self,tapout,radius=10,width=0.45,coupler1_angle=0,coupler1_width=0.45,gap1=0.45,w_heater=3.5,wg_type='strip',coupler2_angle=0,coupler2_width=0,gap2=0.45):
        super(mx_std_ring_resonator, self).__init__(tapout,radius,width,coupler1_angle,coupler1_width,gap1,w_heater,wg_type,coupler2_angle,coupler2_width,gap2)   
...
class mx_crow_euler_bend_racetrack(mdl.my_crow_euler_bend_racetrack):
    def __init__ (self,tapout,gaps,w1,w0,R1,R0,R2,w_heater,w_cp,w_wg,dC,dLx=0,dLy=0,cp_type='BDC',heater_type='connected'):
        super(mx_crow_euler_bend_racetrack,self).__init__(tapout,gaps,w1,w0,R1,R0,R2,w_cp,w_wg,dC,cp_type,heater_type,w_heater,dLx,dLy)
